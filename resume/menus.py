...
Menu.add_item("main", MenuItem("My Resume", reverse(resume_vw.show_resume), weight=10))
Menu.add_item("main", MenuItem("Project Info", reverse(resume_vw.project_markdown), weight=10))
