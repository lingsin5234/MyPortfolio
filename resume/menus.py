...
Menu.add_item("main", MenuItem("My Projects & Blogs", reverse(resume_vw.projects_list), weight=10))
Menu.add_item("main", MenuItem("Portfolio Project Info", reverse(resume_vw.project_markdown), weight=10))
